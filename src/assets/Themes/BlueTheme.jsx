    ...
    <div className="relative w-full">
      ...
      {profile.cover_pic_url ? (
        <div className="w-full h-52 sm:h-64 md:h-72 overflow-hidden relative">
          <img src={profile.cover_pic_url} alt="Cover" className="object-cover w-full h-full" />
      ...
      <div className="relative -mt-16 flex flex-col items-center text-center px-4 pb-8">
        ...
        />
        <h1 className="text-3xl font-semibold text-gray-900 leading-tight">{profile.full_name || "Guest User"}</h1>
        {profile.role && <p className="text-lg text-gray-700 font-medium mt-1">{profile.role}</p>}
...
----------------------------------------- */
export default function BlueTheme({ profile }) {
